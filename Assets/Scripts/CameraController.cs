...
public class CameraController : MonoBehaviour
{
    ...
    private bool hasTarget { get { return target != null; } }
    ...
    public void GoBackToDefault()
    {
        ...
        //Kembali ke posisi default dalam waktu return time
        StopAllCoroutines();
    ...
    private IEnumerator MovePosition(Vector3 target, float time)
    {
        ...
        while (timer < time)
        {
            //Pindahkan posisi kamera secara bertahap dalam waktu return time
